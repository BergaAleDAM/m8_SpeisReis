...
public class GameScreen implements Screen {
    ...
    private GlyphLayout puntuacion;
    ...
    public GameScreen(Batch prevBatch, Viewport prevViewport) {
        ...
        textLayout.setText(AssetManager.font, "Set Difficulty");
        ...
        puntuacion = new GlyphLayout();


        btndifisi =  new Image(AssetManager.btnDifisi);
        btndifisi.setVisible(true);
        btndifisi.setX((Settings.GAME_WIDTH/4));
        btndifisi.setY((Settings.GAME_HEIGHT/2)-15);


        btnfasi = new Image(AssetManager.btnFasi);
        btnfasi.setVisible(true);
        btnfasi.setX((Settings.GAME_WIDTH/4)+(Settings.GAME_WIDTH/2)-30);
        btnfasi.setY((Settings.GAME_HEIGHT/2)-15);
    ...
    private void updateReady() {
        ...
        batch.begin();
        AssetManager.font.draw(batch, textLayout, (Settings.GAME_WIDTH / 2) - textLayout.width / 2, (Settings.GAME_HEIGHT / 2) - textLayout.height / 2-50);


        //stage.addActor(textLbl);


        scrollHandler.puntuacion = 0;
        batch.end();
    ...
    private void updateRunning(float delta) {
        ...
        actores.removeValue(btndifisi,false);
        actores.removeValue(btnfasi,false);
        //System.out.println(actores);


        batch.begin();

        puntuacion.setText(AssetManager.font, "Puntos : " + scrollHandler.puntuacion);
        AssetManager.font.draw(batch, puntuacion, Settings.GAME_WIDTH-180, 2);
        ...
        if (scrollHandler.collides(spacecraft)) {
            ...
            if(scrollHandler.puntuacion > record){
                record = scrollHandler.puntuacion;
            }

            textLayout.setText(AssetManager.font, "Record: " + record);
